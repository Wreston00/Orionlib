...
local WrestonButton = Instance.new("TextButton")
WrestonButton.Size = UDim2.new(0, 100, 0, 50)
WrestonButton.Position = UDim2.new(0, 10, 0, 10)
WrestonButton.BackgroundColor3 = Color3.new(0.5, 0.5, 0.5)
WrestonButton.Text = "Wreston"
WrestonButton.Parent = screenGui 

local isMainVisible = true

WrestonButton.MouseButton1Click:Connect(function()
...
MakeDraggable(WrestonButton, WrestonButton)
